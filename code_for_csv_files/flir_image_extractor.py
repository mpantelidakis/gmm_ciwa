...
class FlirImageExtractor:
    ...
    def save_images(self):
        ...
        if self.use_thumbnail:
            image_filename = os.path.join(fn_prefix + '/' + fn_prefix.split('/')[2] + self.thumbnail_suffix)
    ...
    def export_data_to_csv(self):
        ...
        fn_prefix, _ = os.path.splitext(self.flir_img_filename)
        # print(type(fn_prefix))
        path = os.path.join('../data/csv_files/' + fn_prefix.split('/')[3] + self.csv_suffix)
        # print(path)
    ...
    def crop_center(self, img, cropx=342, cropy=504):
        """
    ...
    def crop_rgb_image(self):
        ...
        self.cropped_visual_np = self.crop_image_only_outside(self.rgb_image_np, 30)
    ...
    def image_metadata_to_csv(self):
        ...
        fn_prefix, _ = os.path.splitext(self.flir_img_filename)
        path = os.path.join(fn_prefix + '/' + fn_prefix.split('/')[2] + self.metadata_csv_suffix)
...
if __name__ == '__main__':
    ...
    if args.actions:
        ...
        image_path_list = glob.glob("../data/flir_images/*.jpg")
